      ...
      <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('pengepul.trash-in.create') }}" class="btn btn-primary" type="button">Add Trash In</a>
              </div>
          <div class="card-body">
                ...
                <tbody>
                    @foreach ($incomes as $item)
                        ...
                        <td>
                            ...
                            <td>
                                <form method="POST" action="{{ route('pengepul.trash-in.delete', $item->id) }}">
                                    @csrf
                                    <a href="{{ route('pengepul.trash-in.edit', [$item->id]) }}" type="button" class="btn btn-primary btn-xs edit" data-bs-id=""><i
