...
<div class="page-body">
  <div class="container-fluid">
    <div class="page-header">
      <div class="row">
        <div class="col-sm-6">
          <h3>Create Plastic Type Price</h3>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Applications</a></li>
            <li class="breadcrumb-item">Data Sampah</li>
            <li class="breadcrumb-item active">Create Plastic Type Price</li>
          </ol>
        </div>
        <div class="col-sm-6">
          <!-- Bookmark Start-->
      ...
      <div class="card">
        <div class="card-body">
          <div class="table-responsive">
            <div class="col-lg-12">
              <div class="card p-3">
                <form method="post" class="needs-validation" novalidate="" action="{{ route('plastic-type-price.store') }}">
                  @csrf
                  @if ($errors->any())
                  ...
                  <div class="row g-2">
                    <div class="col-md-6">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control js-example-basic-single col-sm-12" name="plastic_type_id" id="plastic_type_id">
