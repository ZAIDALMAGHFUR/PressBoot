        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Data Pengepul</li>
            </ol>
          </div>
          <div class="col-sm-6">
            <!-- Bookmark Start-->
                ...
                <table class="display table table-bordered" id="basic-1">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            @if ($item->active == 0)
                                <form method="POST" action="{{ route('pengepul.activateUser', $item->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" class="btn btn-primary btn-xs"><i class="fa fa-check"></i></button>
                                  </form>
                            @endif
                          <form method="POST" action="{{ route('pengepul.delete', $item) }}">
                            @csrf
                            @method('DELETE')
